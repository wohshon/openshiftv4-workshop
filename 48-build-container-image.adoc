...
* This should exit the editor and you can do a `cat secret.yaml` to confirm the file has been saved correctly
...
* Link that secret to your project's builder service account. Your secret name may be different from the one listed.

- run ```oc secrets link builder <secret name>``` as shown in the example below
